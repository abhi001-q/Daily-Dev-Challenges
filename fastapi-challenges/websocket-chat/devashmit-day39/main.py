"""Real-time Chat with WebSockets — Day 39 FastAPI | Author: devashmit"""
...
async def index():
    return HTMLResponse("""<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><title>WS Chat</title>
...
<body><h1>💬 WebSocket Chat</h1>
<div class="setup"><input id="room" placeholder="Room" value="general"/><input id="username" placeholder="Name" value="User"/><button onclick="connect()">Join</button></div>
<p id="status">Not connected</p><div id="messages"></div>
