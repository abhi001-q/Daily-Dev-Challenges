...
export default function App(){
  ...
  if(user)return(<div className="card"><div className="dash"><span style={{fontSize:"2.5rem"}}>🎉</span><h1>Dashboard</h1><p>Logged in as</p><p className="user">@{user}</p><p className="note">httpOnly cookie — XSS safe</p><button className="btn btn-d" onClick={logout}>Logout</button></div></div>);
